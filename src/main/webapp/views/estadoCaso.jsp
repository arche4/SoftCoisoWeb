...
<html lang="en">
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li  class="active"><a href="${pageContext.servletContext.contextPath}/views/estadoCaso.jsp">Estados de caso</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Estados Casos </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#modEstado" style="margin: 10px;">
                            Crear Estado
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="modEstado" >
                                    ...
                                    <form id="estadoCaso" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Estado</label>
                                                <input type="text" class="form-control" id="codEstado" name="codEstado"  placeholder="Codigo" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Estado</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control " id="descripEstado" name="descripEstado" ></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="estado" items="${sessionScope.Estado}" varStatus="myIndex">
                                            <tr>
                                                ...
                                                <td><c:out value="${estado.getDescripcion()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${estado.getCodigoEstado()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="verEstado" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    ...
                                    <br>
                                    <form id="estadoVer" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Estado</label>
                                                <input type="text" class="form-control" id="estadoCodigo" name="estadoCodigo"  placeholder="Codigo" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Estado</label>
                                                <input type="text" class="form-control" id="estadoNom" name="estadoNom" placeholder="Nombre" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Descripcion</label>
                                                <textarea class="form-control " id="estadoDescrip" name="estadoDescrip" ></textarea>
                                            </div>
                                        </div>
                                        <br><br><br><br><br><br><br><br><br><br>
                                        <div class="modal-footer">
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/estado.js" type="text/javascript"></script>
