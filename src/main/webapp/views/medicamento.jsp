...
<html lang="en">
    ...
    <head>
        ...
        <title>SofCoiso-Medicamentos</title>
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/medicamento.jsp">Medicamentos</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    ...
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#medicamentoMod" style="margin: 10px;">
                            Crear Medicamento
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="medicamentoMod" >
                                    ...
                                    <form id="medicamento" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="codMed" name="codMed"  placeholder="Codigo Medicamento" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Medicamento</label>
                                                <input type="text" class="form-control" id="nomMed" name="nomMed" placeholder="Nombre Medicamento" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Descripcion Medicamento</label>
                                                <textarea class="form-control " id="descripMed" name="descripMed" ></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="medicamento" items="${sessionScope.listMedicamento}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${medicamento.getCodigoMedicamento()}"/></td>
                                                <td><c:out value="${medicamento.getNombreMedicamento()}"/></td>
                                                <td><c:out value="${medicamento.getDescripcionMedicamento()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="consultarMedicamento" 
                                                            name="consultarMedicamento" class="btn btn-link" value="${medicamento.getCodigoMedicamento()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="verMedicamento" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    ...
                                    <form id="medicamento" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Medicamento</label>
                                                <input type="number" class="form-control" id="medCod" name="medCod"  placeholder="Codigo Medicamento" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Medicamento</label>
                                                <input type="text" class="form-control" id="medNom" name="medNom" placeholder="Nombre Medicamento" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" id="modales-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button  type="submit" class="btn btn-success" id="btnModificar" onclick="modificarMedicamento()">
                                                Si
                                            </button>
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/medicamento.js" type="text/javascript"></script>
