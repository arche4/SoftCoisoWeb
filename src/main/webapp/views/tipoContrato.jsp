...
<html lang="en">
    ...
    <head>
        ...
        <title>SofCoiso-Tipo de Contrato</title>
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/tipoContrato.jsp">Tipos de Contratos</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Tipo de Contrato </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#modContrato" style="margin: 10px;">
                            Crear Tipo de Contrato
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="modContrato" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Crear Tipo de Contrato</h4>
                                    </div>
                                    <br>
                                    <form id="contrato" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Tipo de Contrato</label>
                                                <input type="text" class="form-control" id="codigo" name="codigo"  placeholder="Codigo" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Tipo de Contrato</label>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">Codigo Tipo de Contrato</th>
                                            <th scope="col">Nombre Tipo de Contrato</th>
                                            <th scope="col">Descripcion</th>
                                            <th scope="col">Ver</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="contrato" items="${sessionScope.Contrato}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${contrato.getCodigoTipoContrato()}"/></td>
                                                <td><c:out value="${contrato.getNombre()}"/></td>
                                                <td><c:out value="${contrato.getDescripcion()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${contrato.getCodigoTipoContrato()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="verContrato" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Tipo de Contrato</h4>
                                    </div>
                                    <br>
                                    <form id="contratoVer" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Tipo de Contrato</label>
                                                <input type="text" class="form-control" id="contratoCodigo" name="contratoCodigo"  placeholder="Codigo" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre Tipo de Contrato</label>
                                                <input type="text" class="form-control" id="contratoNom" name="contratoNom" placeholder="Nombre" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Descripcion</label>
                                                <textarea class="form-control " id="contratoDescrip" name="contratoDescrip" ></textarea>
                                            </div>
                                        </div>
                                        <br><br><br><br><br><br><br><br><br><br>
                                        <div class="modal-footer">
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/contrato.js" type="text/javascript"></script>
