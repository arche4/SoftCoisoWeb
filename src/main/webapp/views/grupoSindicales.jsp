...
<html lang="en">
    ...
    <head>
        ...
        <title>SofCoiso-Organización Sindical</title>
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/grupoSindicales.jsp">Grupos Sindicales</a></li>
                            </ul>
                        </li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i>Organización Sindical </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#modSindicato" style="margin: 10px;">
                            Crear Organización 
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="modSindicato" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Crear Organización Sindical</h4>
                                    </div>
                                    <br>
                                    <form id="sindicato" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Codigo Organización Sindical</label>
                                                <input type="text" class="form-control" id="codigo" name="codigo"  placeholder="Codigo" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Nombre Organización Sindical</label>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">Codigo Organización Sindical</th>
                                            <th scope="col">Nombre Organización Sindical</th>
                                            <th scope="col">Ver Organización Sindical</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="sindicato" items="${sessionScope.Sindicato}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${sindicato.getCodigoOrganizacion()}"/></td>
                                                <td><c:out value="${sindicato.getNombre()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${sindicato.getCodigoOrganizacion()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="verSindicato" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Organización Sindical</h4>
                                    </div>
                                    <br>
                                    <form id="sindicatoVer" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Codigo Organización Sindical</label>
                                                <input type="text" class="form-control" id="sindicatoCodigo" name="sindicatoCodigo"  placeholder="Codigo" readonly>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="control-label">Nombre Organización Sindical</label>
                                                <input type="text" class="form-control" id="sindicatoNom" name="sindicatoNom" placeholder="Nombre" required>
                                            </div>
                                        </div>
                                        <br><br><br><br><br><br><br><br>
                                        <div class="modal-footer">
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/sindicato.js" type="text/javascript"></script>
