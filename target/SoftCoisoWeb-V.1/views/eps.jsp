...
<html lang="en">
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/eps.jsp">Listado Eps</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> EPS </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#crearEps" style="margin: 10px;">
                            Crear EPS
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="crearEps" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Crear EPS</h4>
                                    </div>
                                    <br>
                                    <form id="eps" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo EPS</label>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">Codigo EPS</th>
                                            <th scope="col">Nombre EPS</th>
                                            <th scope="col">Ver</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="eps" items="${sessionScope.EPS}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${eps.getCodigoEps()}"/></td>
                                                <td><c:out value="${eps.getNombreEps()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${eps.getCodigoEps()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="modificarEps" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Eps</h4>
                                    </div>
                                    <br>
                                    <form id="epsMod" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo Eps</label>
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/eps.js" type="text/javascript"></script>
