...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/css/zabuto_calendar.css">
    ...
    <body>
        ...
        <script src="${pageContext.servletContext.contextPath}/lib/sparkline-chart.js"></script>
        <script src="${pageContext.servletContext.contextPath}/lib/zabuto_calendar.js"></script>
