...
<html lang="en">
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/arl.jsp">Listado Arl</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> ARL </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#crearArl" style="margin: 10px;">
                            Crear ARL
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="crearArl" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Crear ARL</h4>
                                    </div>
                                    <br>
                                    <form id="arl" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo ARL</label>
                                                <input type="text" class="form-control" id="codigo" name="codigo"  placeholder="Codigo" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre ARL</label>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">Codigo ARL</th>
                                            <th scope="col">Nombre ARL</th>
                                            <th scope="col">Ver</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="arl" items="${sessionScope.ARL}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${arl.getCodigoArl()}"/></td>
                                                <td><c:out value="${arl.getNombreArl()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${arl.getCodigoArl()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="modificarArl" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">ARL</h4>
                                    </div>
                                    <br>
                                    <form id="arlMod" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo ARL</label>
                                                <input type="text" class="form-control" id="codigoMod" name="codigoMod"  placeholder="Codigo" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nombre ARL</label>
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/arl.js" type="text/javascript"></script>
