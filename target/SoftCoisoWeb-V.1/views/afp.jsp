...
<html lang="en">
    ...
    <body>
        <section id="container">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="${pageContext.servletContext.contextPath}/views/afp.jsp">Listado Afp</a></li>
                            </ul>
                        </li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> AFP </h3>
                    <div class="row mt">
                        <!-- page start-->
                        <button class="btn btn-theme" data-toggle="modal" data-target="#crearAfp" style="margin: 10px;">
                            Crear AFP
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="crearAfp" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Crear AFP</h4>
                                    </div>
                                    <br>
                                    <form id="afp" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo AFP</label>
                        ...
                        <div class="content-panel" style="margin: 10px;">
                            <div class="adv-table">
                                <table id="table_id" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">Codigo AFP</th>
                                            <th scope="col">Nombre AFP</th>
                                            <th scope="col">Ver</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="afp" items="${sessionScope.AFP}" varStatus="myIndex">
                                            <tr>
                                                <td><c:out value="${afp.getCodigoAfp()}"/></td>
                                                <td><c:out value="${afp.getNombreAfp()}"/></td>
                                                <td> 
                                                    <button type="button" href="#modalInf" id ="btnConsultar" 
                                                            name="btnConsultar" class="btn btn-link" value="${afp.getCodigoAfp()}"><i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="modal fade" id="modificarAfp" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">AFP</h4>
                                    </div>
                                    <br>
                                    <form id="afpMod" data-toggle="validator">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Codigo AFP</label>
        ...
        <script src="${pageContext.servletContext.contextPath}/JavaScript/afp.js" type="text/javascript"></script>
